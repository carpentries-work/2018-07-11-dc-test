...
venue: "FAKE SITE - TESTING"        # brief name of host site without address (e.g., "Euphoric State University")
address: "123 Fake Street"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "XYZ"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1)
...
humandate: "Jul 11-12"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
